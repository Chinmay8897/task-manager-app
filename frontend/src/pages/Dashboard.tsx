          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="p-2 sm:p-3 bg-blue-100 rounded-xl">
                <CheckSquare className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" aria-hidden="true" />
              </div>
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Total Tasks</p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900" aria-label={`${stats.total} total tasks`}>
                  {stats.total}
                </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="p-2 sm:p-3 bg-yellow-100 rounded-xl">
                <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600" aria-hidden="true" />
              </div>
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Pending Tasks</p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900" aria-label={`${stats.pending} pending tasks`}>
                  {stats.pending}
                </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="p-2 sm:p-3 bg-green-100 rounded-xl">
                <CheckSquare className="w-5 h-5 sm:w-6 sm:h-6 text-green-600" aria-hidden="true" />
              </div>
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Completed Tasks</p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900" aria-label={`${stats.completed} completed tasks`}>
                  {stats.completed}
                </p>
                <p className="text-xs text-gray-500 mt-1">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button
              ...
              className="btn-primary flex items-center justify-center space-x-2 text-sm hover:shadow-md transition-all duration-200 w-full sm:w-auto"
